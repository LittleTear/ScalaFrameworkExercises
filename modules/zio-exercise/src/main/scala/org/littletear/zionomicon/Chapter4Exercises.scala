...
object Chapter4Exercises {
  ...
  object Exercise1{
    ...
    def failWithMessageZio(string:String): ZIO[Any,Throwable,Nothing] = ZIO.attempt(throw new Error(string))
  }
  ...
  object Exercise6 {
    ...
    val parseNumberRefine: ZIO[Any, NumberFormatException, Int] =
  ...
  object Exercise7{
    def left[R, E, A, B](
      ...
      zio.foldZIO(
         e => ZIO.fail(Left(e)),
         a  => a.fold(a => ZIO.succeed(a),b => ZIO.fail(Right(b)))
      )
  ...
  object Exercise9{
    def right[R, E, A, B](
      ...
      zio.foldZIO(
         e => ZIO.fail(Left(e)),
        success => success.fold(a => ZIO.fail(Right(a)),b => ZIO.succeed(b))
      )
